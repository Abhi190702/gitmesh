...
export const createAgentEnableSchema = createAgentSchema.extend({
  sourceIssueId: z.string().uuid().optional().nullable(),
  sourceIssueIds: z.array(z.string().uuid()).optional(),
});

export type CreateAgentEnable = z.infer<typeof createAgentEnableSchema>;
...
export const bulkDeleteAgentsSchema = z.object({
  ids: z.array(z.string().uuid()).min(1).max(200),
});

export type BulkDeleteAgents = z.infer<typeof bulkDeleteAgentsSchema>;
