...
import type { Subproject, SubprojectWorkspace } from "./project.js";
...
export interface IssueAncestorProject {
  ...
  primaryWorkspace: SubprojectWorkspace | null;
}
...
export interface IssueComment {
  ...
  body: string;
  /** Forge integration fields */
  forgeCommentId: string | null;
  syncDirection: "inbound" | "outbound" | null;
  createdAt: Date;
  updatedAt: Date;
}
