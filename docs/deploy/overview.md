...
GitMesh Agents supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying GitMesh Agents?** Use `local_trusted` (the default)
