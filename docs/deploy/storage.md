...
GitMesh Agents stores uploaded files (issue attachments, images) using a configurable storage provider.
...
```
~/.gitmesh-agents/instances/default/data/storage
```
...
```
~/.gitmesh-agents/instances/default/config.json
```
