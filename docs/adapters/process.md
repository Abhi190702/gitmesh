...
- Running a Python script that calls the GitMesh Agents API
...
1. GitMesh Agents spawns the configured command as a child process
2. Standard GitMesh Agents environment variables are injected (`GITMESH_AGENT_ID`, `GITMESH_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the GitMesh Agents API and perform work.
