...
import { models as codexFallbackModels } from "@gitmesh/adapter-codex-local";
import { models as cursorFallbackModels } from "@gitmesh/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@gitmesh/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.GITMESH_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.GITMESH_OPENCODE_COMMAND = "__gitmesh-agents_missing_opencode_command__";
