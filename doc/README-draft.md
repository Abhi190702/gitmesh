...
- The open-source AI-agent orchestrator teams of agents that run projects

- a video

# What is it

GitMesh Agents is a node server & UI that orchestrates a team of agents to run businesses.
...
# GitMesh Agents is right for you if:

- You want to build autonomous projects
- You want to coordinate many different types agents (Gateway, Codex, Claude, Cursor, etc.) to collaborate towards a common goal
