import type { AssetImage } from "@gitmesh/core";
import { api } from "./client";

export const assetsApi = {
  uploadImage: async (projectId: string, file: File, namespace?: string) => {
    ...
    return api.postForm<AssetImage>(`/projects/${projectId}/assets/images`, form);
  },
};
