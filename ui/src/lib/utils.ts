...
import { deriveAgentUrlKey, deriveProjectUrlKey } from "@gitmesh/core";
...
export function subprojectRouteRef(project: { id: string; urlKey?: string | null; name?: string | null }): string {
...
export function subprojectUrl(project: { id: string; urlKey?: string | null; name?: string | null }): string {
  return `/projects/${subprojectRouteRef(project)}`;
}
