...
export function InviteLandingPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-md border border-border bg-card p-6">
          <h1 className="font-display text-2xl tracking-tight text-foreground">Invite not available</h1>
  ...
  if (result?.kind === "bootstrap") {
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-md border border-border bg-card p-6">
          <h1 className="font-display text-2xl tracking-tight text-foreground">Bootstrap complete</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            The first instance admin is now configured. You can continue to the maintainer dashboard.
          </p>
  ...
  if (result?.kind === "join") {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-md border border-border bg-card p-6">
          <h1 className="font-display text-2xl tracking-tight text-foreground">Join request submitted</h1>
          <p className="mt-2 text-sm text-muted-foreground">
          ...
          {(onboardingSkillUrl || onboardingSkillPath || onboardingInstallPath) && (
            <div className="mt-3 space-y-1 rounded-md border border-border bg-muted/30 p-3 text-xs text-muted-foreground">
              <p className="font-medium text-foreground">GitMesh Agents skill bootstrap</p>
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-md border border-border bg-card p-6">
        <h1 className="font-display text-3xl tracking-tight text-foreground">
          {invite.inviteType === "bootstrap_ceo" ? "Bootstrap your GitMesh Agents instance" : "Join this GitMesh Agents project"}
        </h1>
