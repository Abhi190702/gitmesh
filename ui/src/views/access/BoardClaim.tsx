...
export function BoardClaimPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-md border border-border bg-card p-6">
          <h1 className="font-display text-2xl tracking-tight text-foreground">Claim challenge unavailable</h1>
  ...
  if (status.status === "claimed") {
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-md border border-border bg-card p-6">
          <h1 className="font-display text-2xl tracking-tight text-foreground">Maintainer ownership claimed</h1>
          <p className="mt-2 text-sm text-muted-foreground">
  ...
  if (!sessionQuery.data) {
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-md border border-border bg-card p-6">
          <h1 className="font-display text-2xl tracking-tight text-foreground">Sign in required</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in or create an account, then return to this page to claim maintainer ownership.
          </p>
          <Button asChild className="mt-4">
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-md border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">Claim maintainer ownership</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          This will promote your user to instance admin and migrate project ownership access from local trusted mode.
        </p>

        {claimMutation.error && (
          <p className="mt-3 text-sm text-destructive">
            {claimMutation.error instanceof Error ? claimMutation.error.message : "Failed to claim maintainer ownership"}
          </p>
        )}
