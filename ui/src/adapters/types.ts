...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@gitmesh/adapter-sdk";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@gitmesh/adapter-sdk").TranscriptEntry[];
